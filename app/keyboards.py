...
# ---------------- Inline keyboards ----------------
CATEGORIES = [
    ("👪 Сімейне", "family"), ("🧰 Трудове", "labor"),
    ("🛂 Міграційне", "migration"), ("📄 Договори", "contracts"),
    ("🏠 Нерухомість", "realty"), ("🏢 Корпоративне", "corporate"),
    ("💰 Податки", "tax"), ("🧩 Інше", "other"),
]
...
# (в проекте больше не используем тайм-слоты; функции оставлены на всякий случай)
